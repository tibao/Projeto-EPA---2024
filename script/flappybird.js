...
//fisicas
let velocityX = -10; //velocidade dos canos movendo para a esquerda
let velocityY = 0;
let gravity = 0.3; //gravidade dificil de balancear
...
function startGame() {
    ...
    setInterval(placePipes,500); //gera um cano a cada 1.5 segundos
